...
| — | t14 | r1 | plan 先于实验 + 渐进计划 + 人工纠偏回写 | Policy 归 work-planning；可执行 guard 由 protocol / pause tests 覆盖 | ✅ done | 0 |
| — | t15 | r2 | Plan Revision + Harness pause gate | 21 个测试全绿；pause 中断运行，三方 revision 一致后 resume | ✅ done | 0 |
| — | t16 | r1 | Stable Kernel / Policies / Adapters 重构 | 21 个测试全绿；README 入口化；core 兼容 façade；transition 独立测试 | ✅ done | 0 |
| — | t17 | r2 | 单 plan document + event-driven Goal Review | 28 个测试全绿；action/time/failure/preCompact 与 continue/replan/stop | ✅ done | 0 |
